...
% Source parameters
refFreq = 2;
f0 = 1.0e6;                                                                   % center frequency (of the signal transmitted by the source) [Hz]
...
freqRatio = f0/refFreq;
dx = freqRatio*(lambda/8);                                                                % grid size along x-dimension -> lambda/8 is a good approximation
...
savefig(h,'./Results/FocusedBeam1MHz.fig');
...
savefig(z, './Results/BeamProfliles1MHz.fig');
...
% ylabel('Pressure [MPa]')
savefig(lateralRes, './Results/LateralResolution1MHz.fig');
