%% ========================================================================
%% Simulate field patterns L. Demi 03-09-2018
%% Last modifications F. Mento 13-10-2021
%% ========================================================================
...
% Source parameters
f0 = 2.5e6;                                                                   % center frequency (of the signal transmitted by the source) [Hz]
...
% assign the input options
input_args = {'DisplayMask', display_mask, 'PMLInside', false, 'PlotPML', false,'RecordMovie', true, 'MovieName', 'Focused Sub-aperture'};
% run the simulation
sensor_data = kspaceFirstOrder2D(kgrid, medium, source, sensor, input_args{:});
...
xlabel('x-axis [mm]')
ylabel('z-axis [mm]')
title('Focused Sub-aperture')

FocusedSubApertureField=sensor_data.p_max*Ps;
...
Depths=round([0.01 0.02 0.03]./dx);

figure(5)
subplot(3,2,1)
plot(xaxis*1e3,20*log10(abs(PlaneWaveField(Depths(1),:))))
hold on
plot(xaxis*1e3,20*log10(abs(PlaneWaveField(Depths(2),:))))
plot(xaxis*1e3,20*log10(abs(PlaneWaveField(Depths(3),:))))
axis([-10 10 90 130])
legend('10 mm','20 mm','30 mm')
ylabel('Pressure [dB Re 1 Pa]')
xlabel('x-axis [mm]')
title('Plane Wave')

subplot(3,2,2)
plot(xaxis*1e3,20*log10(abs(PlaneWaveField(Depths(1),:)))-max(max(20*log10(abs(PlaneWaveField(Depths(1),:))))))
hold on
plot(xaxis*1e3,20*log10(abs(PlaneWaveField(Depths(2),:)))-max(max(20*log10(abs(PlaneWaveField(Depths(2),:))))))
plot(xaxis*1e3,20*log10(abs(PlaneWaveField(Depths(3),:)))-max(max(20*log10(abs(PlaneWaveField(Depths(3),:))))))
legend('10 mm','20 mm','30 mm')
ylabel('Normalized Amplitude [dB]')
xlabel('x-axis [mm]')
title('Plane Wave')
...
subplot(3,2,3)
plot(xaxis*1e3,20*log10(abs(FocusedField(Depths(1),:))))
hold on
plot(xaxis*1e3,20*log10(abs(FocusedField(Depths(2),:))))
plot(xaxis*1e3,20*log10(abs(FocusedField(Depths(3),:))))
legend('10 mm','20 mm','30 mm')
ylabel('Pressure [dB Re 1 Pa]')
xlabel('x-axis [mm]')
title('Focused')
...
subplot(3,2,4)
plot(xaxis*1e3,20*log10(abs(FocusedField(Depths(1),:)))-max(max(20*log10(abs(FocusedField(Depths(1),:))))))
hold on
plot(xaxis*1e3,20*log10(abs(FocusedField(Depths(2),:)))-max(max(20*log10(abs(FocusedField(Depths(2),:))))))
plot(xaxis*1e3,20*log10(abs(FocusedField(Depths(3),:)))-max(max(20*log10(abs(FocusedField(Depths(3),:))))))
legend('10 mm','20 mm','30 mm')
ylabel('Normalized Amplitude [dB]')
xlabel('x-axis [mm]')
title('Focused')
...
subplot(3,2,5)
plot(xaxis*1e3,20*log10(abs(FocusedSubApertureField(Depths(1),:))))
hold on
plot(xaxis*1e3,20*log10(abs(FocusedSubApertureField(Depths(2),:))))
plot(xaxis*1e3,20*log10(abs(FocusedSubApertureField(Depths(3),:))))
legend('10 mm','20 mm','30 mm')
ylabel('Pressure [dB Re 1 Pa]')
xlabel('x-axis [mm]')
title('Focused Sub-aperture')
...
subplot(3,2,6)
plot(xaxis*1e3,20*log10(abs(FocusedSubApertureField(Depths(1),:)))-max(max(20*log10(abs(FocusedSubApertureField(Depths(1),:))))))
hold on
plot(xaxis*1e3,20*log10(abs(FocusedSubApertureField(Depths(2),:)))-max(max(20*log10(abs(FocusedSubApertureField(Depths(2),:))))))
plot(xaxis*1e3,20*log10(abs(FocusedSubApertureField(Depths(3),:)))-max(max(20*log10(abs(FocusedSubApertureField(Depths(3),:))))))
legend('10 mm','20 mm','30 mm')
ylabel('Normalized Amplitude [dB]')
xlabel('x-axis [mm]')
title('Focused Sub-aperture')
...
% lateral resolution
PWProfile1=20*log10(abs(PlaneWaveField(Depths(1),:)))-max(max(20*log10(abs(PlaneWaveField(Depths(1),:)))));
PWProfile2=20*log10(abs(PlaneWaveField(Depths(2),:)))-max(max(20*log10(abs(PlaneWaveField(Depths(2),:)))));
PWProfile3=20*log10(abs(PlaneWaveField(Depths(3),:)))-max(max(20*log10(abs(PlaneWaveField(Depths(3),:)))));

FProfile1=20*log10(abs(FocusedField(Depths(1),:)))-max(max(20*log10(abs(FocusedField(Depths(1),:)))));
FProfile2=20*log10(abs(FocusedField(Depths(2),:)))-max(max(20*log10(abs(FocusedField(Depths(2),:)))));
FProfile3=20*log10(abs(FocusedField(Depths(3),:)))-max(max(20*log10(abs(FocusedField(Depths(3),:)))));

FsaProfile1=20*log10(abs(FocusedSubApertureField(Depths(1),:)))-max(max(20*log10(abs(FocusedSubApertureField(Depths(1),:)))));
FsaProfile2=20*log10(abs(FocusedSubApertureField(Depths(2),:)))-max(max(20*log10(abs(FocusedSubApertureField(Depths(2),:)))));
FsaProfile3=20*log10(abs(FocusedSubApertureField(Depths(3),:)))-max(max(20*log10(abs(FocusedSubApertureField(Depths(3),:)))));

width=(find(PWProfile1>-6));
PWlr(1)=dx*(width(end)-width(1))*1e3;
width=(find(PWProfile2>-6));
PWlr(2)=dx*(width(end)-width(1))*1e3;
width=(find(PWProfile3>-6));
PWlr(3)=dx*(width(end)-width(1))*1e3;

width=(find(FProfile1>-6));
Flr(1)=dx*(width(end)-width(1))*1e3;
width=(find(FProfile2>-6));
Flr(2)=dx*(width(end)-width(1))*1e3;
width=(find(FProfile3>-6));
Flr(3)=dx*(width(end)-width(1))*1e3;

width=(find(FsaProfile1>-6));
Fsalr(1)=dx*(width(end)-width(1))*1e3;
width=(find(FsaProfile2>-6));
Fsalr(2)=dx*(width(end)-width(1))*1e3;
width=(find(FsaProfile3>-6));
Fsalr(3)=dx*(width(end)-width(1))*1e3;
...
legend('PW','Focused Sub-Aperture','Focused')

% max pressure
MaxPressure = [max(max(PlaneWaveField)),max(max(FocusedSubApertureField)),max(max(FocusedField))];
figure(7)
plot(MaxPressure./1e6)
xlabel('1=PW, 2=Fsa, 3=F')
ylabel('Pressure [MPa]')
